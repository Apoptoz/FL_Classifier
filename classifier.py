...
def infer(rules, data):
    ...
    for datum in data:
        for rule in rules:
            ...
            # find which class is most confident, then apply rule and add to appropriate class
